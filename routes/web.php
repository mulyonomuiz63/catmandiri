...
Route::group(['middleware' => ['auth', 'accountIsActive']], function () {
    Route::group(['prefix' => 'user', 'as' => 'user.'], function () {
        ...
        Route::get('account-balances/{transaction}/payment-confirmations', [UserAccountBalanceController::class, 'paymentConfirmation'])->name('account-balances.payment-confirmations');
        Route::post('account-balances/{transaction}/payment-confirmations', [UserAccountBalanceController::class, 'storePaymentConfirmation']);
        Route::post('account-balances/pay', [UserAccountBalanceController::class, 'pay']);
        Route::resource('account-balances', UserAccountBalanceController::class)->only(['index', 'store', 'show']);
        ...
        Route::post('transactions/pay', [UserTransactionController::class, 'pay']);
