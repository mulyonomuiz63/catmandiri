                            ...
                            <div class="card-body">
                                <form @submit.prevent="submit" class="row g-3">
                                    <div class="p-5">
                                        ...
                                        <p class="text-muted">
                                            Pastikan nomor handphone yang
                                            dimasukan adalah nomor handphone
                                        ...
                                        <div class="mb-3 mt-0">
                                            ...
                                            <input
                                                ...
                                                class="form-control"
                                                placeholder="Contoh: 081212126043"
                                            />
                                            <div
                                            ...
                                            <p class="text-muted">
                                                ...
                                                <a
                                                    :href="`https://wa.me/${
                                                        ...
                                                        'Hallo, Admin saya sudah daftar dan ingin reset password, ketika konfirmasi nomor tidak terdaftar, berikut data saya untuk perbaikan:\n\nNama:\nEmail:\nNomor Handphone Aktif:\n\n terimakasih.'
                                                    )}`"
                                                    target="_blank"
                                                    >klik disini</a
                                                >
