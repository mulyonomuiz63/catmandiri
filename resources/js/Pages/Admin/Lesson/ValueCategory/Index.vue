                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr
                                    v-for="(
                                        valueCategory, index
                                    ) in valueCategories.data"
                                    :key="index"
                                >
                                    <td>
                                        {{
                                            ++index +
                                            (valueCategories.current_page - 1) *
                                                valueCategories.per_page
                                        }}
                                    </td>
                                    <td>
                                        <span class="badge bg-primary">{{
                                            valueCategory.lesson.lesson_category
                                                .category.name
                                        }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        {{
                                            valueCategory.assessment_type == 1
                                                ? "Nilai = Jumlah Benar : Total Soal"
                                                : valueCategory.assessment_type ==
                                                  2
                                                ? "Nilai = Jumlah Jawaban Benar"
                                                : valueCategory.assessment_type ==
                                                  3
                                                ? "Nilai = Linear Scope"
                                                : "Nilai = Jumlah Benar : Total Menjawab"
                                        }}
                                    </td>
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link
                                                :href="`/admin/value-categories/${valueCategory.id}/detail-value-categories`"
                                                class="ms-1"
                                                ><i class="bx bx-grid-alt"></i
                                            ></Link>
                                            <Link
                                                :href="`/admin/value-categories/${valueCategory.id}/edit`"
                                                class="ms-1"
                                ...
                                <tr>
                                    <td
                                        align="center"
                                        colspan="7"
                                        v-if="!valueCategories.data.length"
                                    >
                                        Data Tidak Tersedia
                                    </td>
                                </tr>
