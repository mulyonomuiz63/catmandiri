                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.total_choices"
                                :class="{ 'is-invalid': errors.total_choices }"
                                placeholder="Jumlah Pilihan"
                            />
                            <div
                                v-if="errors.total_choices"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Jumlah Sesi / Kolom</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.total_section"
                                :class="{ 'is-invalid': errors.total_section }"
                                placeholder="Jumlah Sesi / Kolom"
                            />
                            <div
                                v-if="errors.total_section"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Nilai Ambang Batas (Optional)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.passing_grade"
                                :class="{ 'is-invalid': errors.passing_grade }"
                                placeholder="Nilai Ambang Batas"
                            />
                            <div
                                v-if="errors.passing_grade"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Tambahkan Kategori Penilaian</label
                            >
                            <select
                                v-model="form.add_value_category"
                                :class="{
                                    'is-invalid': errors.add_value_category,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                            ...
                            <div
                                v-if="errors.add_value_category"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.add_value_category == 1">
                            ...
                            >
                                ...
                                <option value="1">
                                    Dihitung Per Kategori Penilaian
                                </option>
                                <option value="2">
                                    Dihitung Untuk Seluruh Soal (Rata-rata)
                                </option>
                                <option value="3">
                                    Dihitung Berdasarkan Poin Jawaban Benar
                                </option>
                                <option value="4">
                                    Dihitung Berdasarkan Bobot Jawaban
                                </option>
                            </select>
                            <div
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            // send data to server
            Inertia.put(
                `/admin/question-titles/${props.questionTitle.id}`,
                {
                    // data
