            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        <div
                            v-if="
                                questionTitle.add_value_category == 1 &&
                                questionTitle.assessment_type == 1
                            "
                            class="col-12"
                        >
                            <label class="form-label">Kategori Penilaian</label>
                            <select
                                v-model="form.value_category_id"
                                :class="{
                                    'is-invalid': errors.value_category_id,
                                }"
                                class="form-select"
                            >
                        ...
                        <div class="col-12">
                            ...
                            <input
                                ...
                                placeholder="Bagian Ke"
                                :readonly="questionTitle.total_section == 1"
                            />
                        ...
                        <div class="col-12">
                            ...
                            <select
                                v-model="form.audio_input"
                                :class="{ 'is-invalid': errors.audio_input }"
                                class="form-select"
                            >
                        ...
                        <div class="col-12" v-if="form.audio_input == 1">
                            <label class="form-label"
                                >Batasan Audio Bisa Diputar</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.audio_played_limit"
                                :class="{
                                    'is-invalid': errors.audio_played_limit,
                                }"
                                placeholder="Batasan Audio Bisa Diputar"
                            />
                            <div
                                v-if="errors.audio_played_limit"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.audio_input == 1">
                            <label class="form-label"
                                >Batas Waktu Menjawab (Detik), Input 0 Jika
                                Tidak Ada Batasan</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.audio_answer_time"
                                :class="{
                                    'is-invalid': errors.audio_answer_time,
                                }"
                                placeholder="Batas Waktu Menjawab Sesudah Audio Di Putar"
                            />
                            <div
                                v-if="errors.audio_answer_time"
                                class="invalid-feedback"
                            >
                        ...
                        <div
                            v-if="1 <= questionTitle.total_choices"
                            class="col-12"
                        >
                        ...
                        <div
                            v-if="2 <= questionTitle.total_choices"
                            class="col-12"
                        >
                        ...
                        <div
                            v-if="3 <= questionTitle.total_choices"
                            class="col-12"
                        >
                        ...
                        <div
                            v-if="4 <= questionTitle.total_choices"
                            class="col-12"
                        >
                        ...
                        <div
                            v-if="5 <= questionTitle.total_choices"
                            class="col-12"
                        >
                        ...
                        <div
                            class="col-12"
                            v-if="questionTitle.assessment_type == 4"
                        >
                            ...
                            <input
                                ...
                                :class="{ 'is-invalid': errors.point_1 }"
                                placeholder="Poin Jawaban A"
                            />
                        ...
                        >
                            ...
                            <input
                                ...
                                :class="{ 'is-invalid': errors.point_2 }"
                                placeholder="Poin Jawaban B"
                            />
                        ...
                        >
                            ...
                            <input
                                ...
                                :class="{ 'is-invalid': errors.point_3 }"
                                placeholder="Poin Jawaban C"
                            />
                        ...
                        >
                            ...
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.point_4"
                                :class="{ 'is-invalid': errors.point_4 }"
                                placeholder="Poin Jawaban D"
                            />
                        ...
                        >
                            ...
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.point_5"
                                :class="{ 'is-invalid': errors.point_5 }"
                                placeholder="Poin Jawaban E"
                            />
                        ...
                        <div
                            class="col-12"
                            v-if="questionTitle.assessment_type == 3"
                        >
                            <label class="form-label"
                                >Poin Setiap Jawaban Benar</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.correct_point"
                                :class="{ 'is-invalid': errors.correct_point }"
                                placeholder="Poin Setiap Jawaban Benar"
                            />
                            <div
                                v-if="errors.correct_point"
                                class="invalid-feedback"
                            >
                        ...
                        >
                            <label class="form-label"
                                >Poin Setiap Jawaban Salah</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.wrong_point"
                                :class="{ 'is-invalid': errors.wrong_point }"
                                placeholder="Poin Setiap Jawaban Salah"
                            />
                            <div
                                v-if="errors.wrong_point"
                                class="invalid-feedback"
                            >
                                {{ errors.wrong_point }}
                            </div>
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                ><b>ID Video Youtube</b></label
                            >
                            <input
                                type="text"
                                class="form-control"
                                v-model="form.discussion_video"
...
export default {
    ...
    setup(props) {
        const form = reactive({
            ...
            section:
                props.questionTitle.total_section == 1
                    ? 1
        ...
        const submit = () => {
            // send data to server
            Inertia.put(
                `/admin/question-titles/${props.questionTitle.id}/questions/${props.question.id}`,
                {
                    // data
