                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <a
                            href="#"
                            @click.prevent="
                                destroyQuestionTitle(questionTitle.id)
                            "
                        ...
                        <div class="ms-auto">
                            <Link
                                ...
                                class="btn btn-primary btn-sm mt-2 mt-lg-0 ms-1"
                                >Kembali</Link
                            >
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr
                                    v-if="questionTitle.add_value_category == 1"
                                >
                                    ...
                                    <td>
                                        ...
                                        <span
                                            v-if="
                                                ...
                                                3
                                            "
                                            >Dihitung Berdasarkan Poin Jawaban
                                            Benar</span
                                        >
                                        <span
                                            v-if="
                ...
                <div class="card-body">
                    ...
                    <div class="d-lg-flex align-items-center gap-3">
                        <div class="ms-auto">
                            <a
                                target="_blank"
                                :href="`/admin/question-titles/${questionTitle.id}/export-excel`"
                                class="btn btn-sm btn-success mt-lg-0"
                                ><i class="bx bxs-file"></i> Export Soal</a
                            >
                        </div>
                        <a
                            target="_blank"
                            :href="`/admin/question-titles/${questionTitle.id}/format-import-excel`"
            ...
            <div class="card" v-if="!questions.data.length">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        <div class="ms-auto">
                            <form
                                @submit.prevent="generateQuestion"
                                class="d-flex ml-auto"
                            >
                                <select
                                ...
                                >
                                    ...
                                    <option value="number_letter">
                                        Kombinasi Angka & Huruf Hilang
                                    </option>
                                    <option value="number_symbol">
                                        Kombinasi Angka & Simbol Hilang
                                    </option>
                                    <option value="letter_symbol">
                                        Kombinasi Huruf & Simbol Hilang
                                    </option>
                                    <option value="number_letter_symbol">
                                        Kombinasi Angka, Huruf & Simbol Hilang
                                    </option>
                                </select>
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <a
                                href="#"
                                @click.prevent="
                                    destroyAllQuestion(questionTitle.id)
                                "
                                class="btn btn-danger btn-sm"
                                ><i class="bx bx-trash"></i> Hapus Semua Soal</a
                            >
                            <Link
                                :href="`/admin/question-titles/${questionTitle.id}/questions/create`"
                                class="btn btn-sm btn-primary m-2"
                                ><i class="bx bxs-plus-square"></i> Tambah
                                Soal</Link
                            >
                        </div>
                    </div>
                    <table class="table mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="border-0" style="width: 85%">
                                    Soal
                                </th>
                                <th
                                ...
                                <td>
                                    ...
                                    >
                                        <audio controls>
                                            <source
                                                v-bind:src="
                                                    '/storage/upload_files/questions/audio/' +
                                                    question.audio
                                                "
                                                type="audio/ogg"
                                            />
                                    ...
                                    <ol
                                        type="A"
                                        v-if="
                                            questionTitle.assessment_type == 4
                                        "
                                    >
                                        <li
                                            v-if="
                                                1 <= questionTitle.total_choices
                                            "
                                            v-html="
                                                '<span class=\'badge bg-danger\'>point ' +
                                                question['point_' + 1] +
                                                '</span> <br>' +
                                                question['option_' + 1]
                                            "
                                    ...
                                    <div
                                        class="badge rounded-pill text-primary bg-light-primary p-2 text-uppercase"
                                        v-if="question.value_category"
                                    >
                                        {{ question.value_category.name }}
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex order-actions">
                                        <Link
                                            :href="`/admin/question-titles/${questionTitle.id}/questions/${question.id}/edit`"
                                            class="ms-1"
...
export default {
    ...
    setup(props) {
        ...
        const importExcel = () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.post(
                        `/admin/question-titles/${props.questionTitle.id}/import-excel`,
                        {
                            forceFormData: true,
                            file: form.file,
                        },
        ...
        const generateQuestion = () => {
            // send data to server
            Inertia.post(
                `/admin/question-titles/${props.questionTitle.id}/questions/generate-question`,
                {
                    type: form.type,
                },
                {
        ...
        const handleSearch = () => {
            Inertia.get(
                `/admin/question-titles/${props.questionTitle.id}/questions`,
                {
        ...
        const destroyAllQuestion = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.get(
                        `/admin/question-titles/${props.questionTitle.id}/delete-question`,
                    );
        ...
        const destroy = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.delete(
                        `/admin/question-titles/${props.questionTitle.id}/questions/${id}`,
                    );
