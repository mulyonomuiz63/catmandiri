<template>
    <Head>
        <title>
            ...
            - Edit Detail Kategori Penilaian
        </title>
    </Head>
    <!--start page wrapper -->
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        <div class="col-12">
                            ...
                            <input
                                ...
                                :class="{ 'is-invalid': errors.min_grade }"
                                placeholder="Nilai Minimal"
                            />
                            <div
                                v-if="errors.min_grade"
                        ...
                        <div class="col-12">
                            ...
                            <input
                                ...
                                :class="{ 'is-invalid': errors.max_grade }"
                                placeholder="Nilai Maksimal"
                            />
                            <div
                                v-if="errors.max_grade"
                                class="invalid-feedback"
                            >
                                {{ errors.max_grade }}
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <input
                                type="text"
                                class="form-control"
                                v-model="form.category_grade"
                                :class="{ 'is-invalid': errors.category_grade }"
                                placeholder="Kategori Nilai"
                            />
                            <div
                                v-if="errors.category_grade"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            ...
                            <input
                                ...
                                :class="{ 'is-invalid': errors.final_grade }"
                                placeholder="Nilai Akhir"
                            />
                            <div
                                v-if="errors.final_grade"
                                class="invalid-feedback"
                            >
                                {{ errors.final_grade }}
                            </div>
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            // send data to server
            Inertia.put(
                `/admin/value-categories/${props.valueCategory.id}/detail-value-categories/${props.detailValueCategory.id}`,
                {
                    // data
