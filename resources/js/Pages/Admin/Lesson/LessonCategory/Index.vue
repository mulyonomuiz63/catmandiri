                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr
                                    v-for="(
                                        lessonCategory, index
                                    ) in lessonCategories.data"
                                    :key="index"
                                >
                                    <td>
                                        {{
                                            ++index +
                                            (lessonCategories.current_page -
                                                1) *
                                                lessonCategories.per_page
                                        }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link
                                                :href="`/admin/lesson-categories/${lessonCategory.id}/edit`"
                                                class="ms-1"
                                ...
                                <tr>
                                    <td
                                        align="center"
                                        colspan="6"
                                        v-if="!lessonCategories.data.length"
                                    >
                                        Data Tidak Tersedia
                                    </td>
                                </tr>
