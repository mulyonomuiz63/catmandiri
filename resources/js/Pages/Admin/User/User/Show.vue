                        ...
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        {{ formatPrice(user.account_balance) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Status Akun</th>
                                ...
                                <tr v-if="user.is_active == 0 && user.student">
                                    ...
                                    <td>
                                        <Link
                                            :href="`/admin/users/${user.id}/send-activation-link`"
                                            class="btn btn-success btn-sm"
                                            >Klik Untuk Mengirim Link
                                            Verifikasi</Link
                                        >
                                    </td>
                                </tr>
                                <tr v-if="user.is_active == 0 && user.student">
                                    ...
                                    <td>
                                        <Link
                                            :href="`/admin/users/${user.id}/activation-reminder`"
                                            class="btn btn-success btn-sm"
                                            >Kirim Reminder Aktivasi Akun</Link
                                        >
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{
                                            user.student && user.student.city
                                                ? user.student.city.name
                                                : "-"
                                        }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{
                                            user.student && user.student.village
                                                ? user.student.village.name
                                                : "-"
                                        }}
                                    </td>
                                </tr>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td>
                                        <span
                                            v-if="member.member_categories"
                                            v-for="member_categories in member.member_categories"
                                    ...
                                    <td>
                                        {{ formatDate(member.expired_date) }}
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td
                                        align="center"
                                        colspan="5"
                                        v-if="!user.user_member_category.length"
                                    >
                                        Data Tidak Tersedia
                                    </td>
                                </tr>
        ...
        const destroy = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.delete(
                        `/admin/users/${props.user.id}/user-member-categories/${id}`
                    );
