                            ...
                            <form @submit.prevent="submit" class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid': errors.app_name,
                                        }"
                                        placeholder="Nama Aplikasi"
                                    />
                                    <div
                                        v-if="errors.app_name"
                                ...
                                <div class="col-12">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid': errors.whatsapp_token,
                                        }"
                                        placeholder="Token Whatsapp"
                                    />
                                    <div
                                        v-if="errors.whatsapp_token"
                                        class="invalid-feedback"
                                    >
                                ...
                                <div class="col-12">
                                    <label class="form-label"
                                        >Nama Tertanda (Tanda Tangan)</label
                                    >
                                    <input
                                        type="text"
                                        class="form-control"
                                        v-model="form.signed_name"
                                        :class="{
                                            'is-invalid': errors.signed_name,
                                        }"
                                        placeholder="Nama Tertanda"
                                    />
                                    <div
                                        v-if="errors.signed_name"
                                        class="invalid-feedback"
                                    >
                                        {{ errors.signed_name }}
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input
                                        ...
                                        "
                                        :class="{
                                            'is-invalid': errors.signed_image,
                                        }"
                                        placeholder="signed_image"
                                    />
                                    <div
                                        v-if="errors.signed_image"
                                        class="invalid-feedback"
                                    >
                                        {{ errors.signed_image }}
                                    </div>
                                ...
                                <div class="col-12">
                                    <label class="form-label"
                                        >Aktifkan Verifikasi User</label
                                    >
                                    <select
                                        v-model="form.add_activation_user"
                                        :class="{
                                            'is-invalid':
                                    ...
                                    <div
                                        v-if="errors.add_activation_user"
                                        class="invalid-feedback"
                                    >
                                        {{ errors.add_activation_user }}
                                    </div>
                                ...
                                <div class="col-12">
                                    <label class="form-label"
                                        >Tipe Pembelian Soal Try Out</label
                                    >
                                    <select
                                        v-model="form.purchase_type"
                                        :class="{
                                            'is-invalid': errors.purchase_type,
                                        }"
                                        class="form-select"
                                    >
                                        <option value="">[ Pilih ]</option>
                                        <option value="1">
                                            Pembelian Per Paket Soal
                                        </option>
                                        <option value="2">
                                            Pembelian Dengan Membership Bulanan
                                        </option>
                                        <option value="3">
                                            Pembelian Per Paket Soal &
                                            Membership Bulanan
