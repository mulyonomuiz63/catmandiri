            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center">
                        <div class="ms-auto">
                            <Link
                                :href="`/admin/exam-groups/${examGroup.id}/exam-group-details`"
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div
                            class="col-12"
                            v-if="examGroup.exam_group_type == 2"
                        >
                        ...
                        >
                            ...
                            <input
                                ...
                                placeholder="Maksimal Toleransi"
                            />
                            <div
                        ...
                        <div
                            class="col-12"
                            v-if="examGroup.assessment_type == 2"
                        >
                            <label class="form-label"
                                >Persentase Nilai Yang Diambil Dari Tes
                                (%)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.percentage_grade"
                                :class="{
                                    'is-invalid': errors.percentage_grade,
                                }"
                                placeholder="Persentase"
                            />
                            <div
                                v-if="errors.percentage_grade"
                                class="invalid-feedback"
                            >
...
export default {
    ...
    setup(props) {
        ...
        axios
            .get(
                `/admin/lesson-categories/${props.examGroup.lesson_category_id}/lessons`
            )
            .then((response) => {
        ...
        const submit = () => {
            // send data to server
            Inertia.put(
                `/admin/exam-groups/${props.examGroup.id}/exam-group-details/${props.exam.id}`,
                {
                    // data
                    exam_group_id: props.examGroup.id,
                    category_id: props.examGroup.category_id,
