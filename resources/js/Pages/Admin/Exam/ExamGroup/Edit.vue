            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Kategori Member (Khusus Untuk Membership
                                Bulanan, Kosongkan Jika Tidak Ada)</label
                            >
                            <VueMultiselect
                        ...
                        <div class="col-12">
                            ...
                            <select
                                ...
                                :class="{
                                    'is-invalid': errors.lesson_category_id,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                            ...
                            <div
                                v-if="errors.lesson_category_id"
                                class="invalid-feedback"
                            >
                            ...
                            <Editor
                                ...
                                :init="{
                                    ...
                                    toolbar:
                                        ...
                                        'link image media | ' +
                                        'print preview | ' +
                                        'forecolor backcolor emoticons | code fullscreen',
                                    image_advtab: true,
                                }"
                            />
                        ...
                        <div class="col-12">
                            ...
                            <select
                                v-model="form.exam_group_type"
                                :class="{
                                    'is-invalid': errors.exam_group_type,
                                }"
                                class="form-select"
                                disabled
                            >
                                <option value="">[ Pilih ]</option>
                                <option value="1">
                                    Tiap Tes Digabung Dalam Satu Waktu
                                </option>
                                <option value="2">
                                    Tiap Tes Memiliki Waktunya Masing-Masing
                                </option>
                            </select>
                            <div
                                v-if="errors.exam_group_type"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            ...
                            <select
                                ...
                                :class="{
                                    'is-invalid': errors.random_question,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            ...
                            <select
                                ...
                                :class="{ 'is-invalid': errors.random_answer }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                                <option value="1">Ya</option>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            ...
                            <select
                                ...
                                :class="{ 'is-invalid': errors.show_answer }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                                <option value="1">Ya</option>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label"
                                >Tampilkan Navigasi Nomor Soal</label
                            >
                            <select
                                v-model="form.show_question_number_navigation"
                                :class="{
                                    'is-invalid':
                            ...
                            <div
                                v-if="errors.show_question_number_navigation"
                                class="invalid-feedback"
                            >
                                {{ errors.show_question_number_navigation }}
                            </div>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label"
                                >Tampilkan Nomor Soal</label
                            >
                            <select
                                v-model="form.show_question_number"
                                :class="{
                                    'is-invalid': errors.show_question_number,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                            ...
                            <div
                                v-if="errors.show_question_number"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label"
                                >Pertanyaan Selanjutnya Secara Otomatis</label
                            >
                            <select
                                v-model="form.next_question_automatically"
                                :class="{
                                    'is-invalid':
                            ...
                            <div
                                v-if="errors.next_question_automatically"
                                class="invalid-feedback"
                            >
                                {{ errors.next_question_automatically }}
                            </div>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label"
                                >Tampilkan Button Sebelum & Selanjutnya</label
                            >
                            <select
                                v-model="form.show_prev_next_button"
                                :class="{
                                    'is-invalid': errors.show_prev_next_button,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                            ...
                            <div
                                v-if="errors.show_prev_next_button"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            ...
                            <select
                                v-model="form.type_option"
                                :class="{ 'is-invalid': errors.type_option }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                                <option value="1">
                                    Button Option dan Soal Menyatu (Normal)
                                </option>
                                <option value="2">
                                    Button Option ke Samping dan jawaban menyatu
                                    dengan soal
                                </option>
                            </select>
                            <div
                                v-if="errors.type_option"
                                class="invalid-feedback"
                            >
                                {{ errors.type_option }}
                            </div>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label"
                                >Tampilan Button Akhiri Ujian / Sesi
                                Selanjutnya</label
                            >
                            <select
                                v-model="form.button_type_finish"
                                :class="{
                                    'is-invalid': errors.button_type_finish,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                                <option value="1">
                                    Ditampilkan Pada Setiap Soal
                                </option>
                                <option value="2">
                                    Hanya Ditampilkan Pada Soal Terakhir
                                </option>
                            </select>
                            <div
                                v-if="errors.button_type_finish"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label"
                                >Siswa Dapat Mengulangi Try Out</label
                            >
                            <select
                                v-model="form.repeat_the_exam"
                                :class="{
                                    'is-invalid': errors.repeat_the_exam,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                        ...
                        <div class="col-12">
                            ...
                            <select
                                ...
                                :class="{
                                    'is-invalid': errors.assessment_type,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                                <option value="1">
                                    Nilai pada tiap tes dijumlahkan
                                </option>
                                <option value="2">
                                    Persentase dari masing-masing tes
                                </option>
                                <option value="3">
                                    Nilai rata-rata dari masing-masing tes
                                </option>
                                <option value="4">
                                    Nilai pada tiap kategori tes dijumlahkan
                                </option>
                            </select>
                            <div
                                v-if="errors.assessment_type"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            ...
                            <select
                                v-model="form.minimal_grade_type"
                                :class="{
                                    'is-invalid': errors.minimal_grade_type,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                                <option value="0">
                                    Tidak Ada Nilai Minimal
                                </option>
                                <option value="1">
                                    Nilai Minimal Di Ambil Dari Ambang Batas
                                    Tiap Tes
                                </option>
                                <option value="2">
                                    Nilai Minimal Ditentukan Untuk Keseluruhan
                                    Tes
                                </option>
                            </select>
                            <div
                                v-if="errors.minimal_grade_type"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.minimal_grade_type == 2">
                            <label class="form-label"
                                >Nilai Minimal Lulus</label
                            >
                            <input
                                type="text"
                                class="form-control"
                                v-model="form.minimal_grade"
                                :class="{ 'is-invalid': errors.minimal_grade }"
                                placeholder="Nilai Minimal Lulus"
                            />
                            <div
                                v-if="errors.minimal_grade"
                                class="invalid-feedback"
                            >
                        ...
                        <div
                            class="col-12"
                            v-if="
                                form.minimal_grade_type == 1 ||
                                form.minimal_grade_type == 2
                            "
                        >
                            <label class="form-label"
                                >Keterangan Nilai Kurang Dari Nilai
                                Minimal</label
                            >
                            <input
                                type="text"
                                class="form-control"
                                v-model="
                                    form.description_grade_less_than_minimal
                                "
                                :class="{
                                    'is-invalid':
                                        errors.description_grade_less_than_minimal,
                                }"
                                placeholder="Keterangan Nilai < Nilai Minimal"
                            />
                            <div
                                v-if="
                                    errors.description_grade_less_than_minimal
                        ...
                        >
                            <label class="form-label"
                                >Keterangan Nilai Lebih Dari Nilai
                                Minimal</label
                            >
                            <input
                                type="text"
                                class="form-control"
                                v-model="
                                    form.description_grade_more_than_minimal
                                "
                                :class="{
                                    'is-invalid':
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Nilai Minimal Yang Ditampilkan (Kosongkan Jika
                                Tidak Ada)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.smallest_value_limit"
                                :class="{
                                    'is-invalid': errors.smallest_value_limit,
                                }"
                                placeholder="Nilai Minimal Yang Ditampilkan"
                            />
                            <div
                                v-if="errors.smallest_value_limit"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Nilai Maksimal Yang Ditampilkan (Kosongkan Jika
                                Tidak Ada)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.biggest_value_limit"
                                :class="{
                                    'is-invalid': errors.biggest_value_limit,
                                }"
                                placeholder="Nilai Maksimal Yang Ditampilkan"
                            />
                            <div
                                v-if="errors.biggest_value_limit"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Izinkan Siswa Mencetak Hasil Ujian</label
                            >
                            <select
                                v-model="form.certificate_print_user"
                                :class="{
                                    'is-invalid': errors.certificate_print_user,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                            ...
                            <div
                                v-if="errors.certificate_print_user"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label"
                                >Maksimal Toleransi Keluar Tes (Kosongkan Jika
                                Tidak Ada)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                v-model="form.total_tolerance"
                                :class="{
                                    'is-invalid': errors.total_tolerance,
                                }"
                                placeholder="Maksimal Toleransi Keluar Tes"
                            />
                            <div
                                v-if="errors.total_tolerance"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Harga TryOut (Sebelum Diskon)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                ...
                                placeholder="Harga TryOut (Sebelum Diskon)"
                                min="0"
                            />
                            <div
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Harga TryOut (Sesudah Diskon)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                ...
                                placeholder="Harga TryOut (Sesudah Diskon)"
                                min="0"
                            />
                            <div
                        ...
                        <div class="col-12">
                            ...
                            <select
                                ...
                                :class="{ 'is-invalid': errors.exam_status }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
    ...
    setup(props) {
        const form = reactive({
            ...
            show_question_number_navigation:
                props.examGroup.show_question_number_navigation ?? "",
            show_question_number: props.examGroup.show_question_number ?? "",
            next_question_automatically:
                props.examGroup.next_question_automatically ?? "",
            ...
            description_grade_less_than_minimal:
                props.examGroup.description_grade_less_than_minimal ?? "",
            description_grade_more_than_minimal:
                props.examGroup.description_grade_more_than_minimal ?? "",
            ...
            member_categories: !props.examGroup.member_categories
                ? []
                : props.examGroup.member_categories.map((item) => {
                      return { name: item };
                  }),
        ...
        const submit = () => {
            // send data to server
            Inertia.put(
                `/admin/exam-groups/${props.examGroup.id}`,
                {
                    // data
                    ...
                    show_question_number_navigation:
                        form.show_question_number_navigation,
                    show_question_number: form.show_question_number,
                    next_question_automatically:
                        form.next_question_automatically,
