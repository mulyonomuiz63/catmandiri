            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <Link
                                href="/admin/exam-groups/create"
                                class="btn btn-primary btn-sm mt-2 mt-lg-0"
                            >
                                <i class="bx bxs-plus-square"></i> Tambah Try
                                Out
                            </Link>
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <Link
                                                :href="`/admin/exam-groups/${exam.id}/students`"
                                                class="ms-1"
                                                ><i class="bx bx-user"></i
                                            ></Link>
                                            <Link
                                                :href="`/admin/exam-groups/${exam.id}/exam-group-details`"
                                                class="ms-1"
                                                ><i class="bx bx-grid-alt"></i
                                            ></Link>
                                            <Link
                                                :href="`/admin/exam-groups/${exam.id}/edit`"
                                                class="ms-1"
