            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <a
                            target="_blank"
                            :href="`/admin/exam-groups/${exam_group_id}/export-pdf`"
                            class="btn btn-danger btn-sm mt-lg-0"
                        >
                            <i class="bx bxs-file"></i> Export PDF
                        </a>
                        <a
                            target="_blank"
                            :href="`/admin/exam-groups/${exam_group_id}/export-excel`"
                            class="btn btn-success btn-sm mt-lg-0"
                        >
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr
                                    v-for="(exam, index) in examGroupUsers.data"
                                    :key="index"
                                >
                                    <td>
                                        {{
                                            ++index +
                                            (examGroupUsers.current_page - 1) *
                                                examGroupUsers.per_page
                                        }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a
                                                target="_blank"
                                                :href="`/admin/exam-groups/${exam.exam_group_id}/students/${exam.id}/export-pdf`"
                                                class="ms-1"
                                                ><i class="bx bx-file"></i
                                            ></a>
                                            <Link
                                                :href="`/admin/exam-groups/${exam.exam_group_id}/students/${exam.id}/grades`"
                                                class="ms-1"
                                ...
                                <tr>
                                    <td
                                        align="center"
                                        colspan="9"
                                        v-if="!examGroupUsers.data.length"
                                    >
                                        Data Tidak Tersedia
                                    </td>
                                </tr>
    ...
    setup() {
        ...
        const regenerateTryoutScore = (examGroupId, examId) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.get(
                        `/admin/exam-groups/${examGroupId}/students/${examId}/regenerate-scores`
                    );
