                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select
                                v-model="form.question_title_id"
                                :class="{
                                    'is-invalid': errors.question_title_id,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                                <option
                                    v-for="questionTitle in form.questionTitles"
                                    :value="questionTitle.id"
                                >
                                    {{ questionTitle.name }}
                                </option>
                            </select>
                            <div
                                v-if="errors.question_title_id"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Durasi Latihan Soal (Menit)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Tampilkan Jawaban Pilihan Ganda</label
                            >
                            <select
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Siswa Dapat Mengulangi Latihan Soal</label
                            >
                            <select
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Tampilkan Koreksi Jawaban & Pembahasan</label
                            >
                            <select
                                v-model="form.show_answer_discussion"
                                :class="{
                                    'is-invalid': errors.show_answer_discussion,
                                }"
                                class="form-select"
                            >
                                <option value="">[ Pilih ]</option>
                            ...
                            <div
                                v-if="errors.show_answer_discussion"
                                class="invalid-feedback"
                            >
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Harga Latihan Soal (Sebelum Diskon)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                ...
                                placeholder="Harga Latihan Soal (Sebelum Diskon)"
                                min="0"
                            />
                            <div
                        ...
                        <div class="col-12">
                            <label class="form-label"
                                >Harga Latihan Soal (Sesudah Diskon)</label
                            >
                            <input
                                type="number"
                                class="form-control"
                                ...
                                placeholder="Harga Latihan Soal (Sesudah Diskon)"
                                min="0"
                            />
                            <div
    ...
    setup(props) {
        const form = reactive({
            ...
            show_question_number_navigation:
                props.exam.show_question_number_navigation,
            ...
            member_categories: !props.exam.member_categories
                ? []
                : props.exam.member_categories.map((item) => {
                      return { name: item };
                  }),
        ...
        axios
            .get(`/admin/lessons/${form.lesson_id}/question-titles`)
            .then((response) => {
