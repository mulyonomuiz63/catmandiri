                    ...
                    <table class="table mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        v-if="exam.member_categories"
                                        v-for="member_categories in exam.member_categories"
                                ...
                                <td>
                                    {{
                                        exam.type_option == 1
                                            ...
                                            : "Button option ke samping & jawaban menyatu dengan soal"
                                    }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                    <span
                                        v-if="exam.exam_status == 'inactive'"
                                        class="badge bg-success"
                                        >Inactive</span
                                    >
                                    <span
                                        v-if="exam.exam_status == 'inprogress'"
            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="text-end">
                            <a
                                :href="`/admin/exams/${exam.id}/export-pdf`"
                                target="_blank"
                                class="btn btn-danger btn-sm m-1"
                                >Export PDF</a
                            >
                            <a
                                :href="`/admin/exams/${exam.id}/export-excel`"
                                target="_blank"
