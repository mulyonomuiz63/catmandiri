                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{
                                                transaction.user.student &&
                                                transaction.user.student.village
                                                    ? transaction.user.student
                                                          .village.name
                                                    : "-"
                                            }}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-sm-9">
                                                <span
                                                    v-if="
                                                        transaction.member_categories
                                                    "
                                                    v-for="member_categories in transaction.member_categories"
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            // send data to server
            Inertia.put(
                `/admin/transactions/${props.transaction.id}`,
                {
                    // data
