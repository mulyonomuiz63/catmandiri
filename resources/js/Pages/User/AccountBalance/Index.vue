        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="mb-0 text-white">Saldo Sekarang</h5>
                </div>
                <div class="card-body">
                    <h3>
                        Rp.
            ...
            <form @submit.prevent="submit">
                <div class="card border-top border-0 border-3 border-primary">
                    <div class="card-header">
                        <h5 class="mb-0">Pilih Nominal To Up</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input
                                    ...
                                    id="primary-outlined-1"
                                    autocomplete="off"
                                    @click="clickBalance(10000)"
                                />
                                <label
                                    class="btn btn-outline-primary w-100"
                                    for="primary-outlined-1"
                                    >Rp. 10.000</label
                                >
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input
                                    ...
                                    class="btn-check"
                                    name="options-outlined"
                                    id="primary-outlined-2"
                                    autocomplete="off"
                                    @click="clickBalance(30000)"
                                />
                                <label
                                    class="btn btn-outline-primary w-100"
                                    for="primary-outlined-2"
                                    >Rp. 30.000</label
                                >
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input
                                    ...
                                    class="btn-check"
                                    name="options-outlined"
                                    id="primary-outlined-3"
                                    autocomplete="off"
                                    @click="clickBalance(50000)"
                                />
                                <label
                                    class="btn btn-outline-primary w-100"
                                    for="primary-outlined-3"
                                    >Rp. 50.000</label
                                >
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-3">
                                <input
                                    ...
                                    class="btn-check"
                                    name="options-outlined"
                                    id="primary-outlined-4"
                                    autocomplete="off"
                                    @click="clickBalance(100000)"
                                />
                                <label
                                    class="btn btn-outline-primary w-100"
                                    for="primary-outlined-4"
                                    >Rp. 100.000</label
                                >
                            </div>
                        </div>
                    </div>
                    <h5 class="mb-0 px-3">Atau Input Nominal Manual</h5>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        :class="{
                                            'is-invalid': errors.top_up_balance,
                                        }"
                                    />
                                    <div
                                        v-if="errors.top_up_balance"
                            ...
                            <div class="col-lg-12">
                                <div class="input-group">
                                    ...
                                    >
                                        ...
                                        <option
                                            v-for="paymentMethod in $page.props.setting.payment_methods.filter(
                                                (pm) =>
                                                    pm.code !==
                                                    'account_balance'
                                            )"
                            ...
                            <tbody>
                                <tr>
                                    <td
                                        align="center"
                                        colspan="4"
                                        v-if="!accountBalances.data.length"
                                    >
                                        Data Top Up Saldo kosong
                                    </td>
                                </tr>
                                <tr
                                    v-for="(
                                        accountBalance, index
                                    ) in accountBalances.data"
                                    :key="index"
                                >
                                    <td>
                                        {{
                                            ++index +
                                            (accountBalances.current_page - 1) *
                                                accountBalances.per_page
                                        }}
                                    </td>
