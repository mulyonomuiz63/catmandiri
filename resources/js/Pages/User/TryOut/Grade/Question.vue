        ...
        <div class="page-content">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="ms-auto mb-3">
                    ...
                    <Link
                        v-else
                        :href="`/user/categories/${grade.category_id}/lesson-categories/${grade.lesson_category_id}/lessons/${grade.lesson_id}/exams/${grade.exam_id}`"
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <li
                                                v-html="
                                                    '<span class=\'badge bg-danger mb-1\'>poin ' +
                                                    question[
                                                        'point_' + answerOrder
                                                    ] +
                                                    '</span>' +
                            ...
                            <table v-if="question">
                                ...
                                <tr
                                    v-if="
                                        exam.question_title.assessment_type != 4
                                    "
                                >
                                    <td>Kunci Jawaban</td>
                                    <td>:</td>
                    ...
                    >
                        ...
                        <div
                            class="card-footer"
                            v-if="question.discussion_video"
                        >
                            <div class="text-center">
                                <button
                                    type="button"
                        ...
                        <div class="card-footer text-center">
                            <div class="row">
                                <div class="col-md-6 sm-12">
                                    <button
                                        type="button"
                                        class="w-100 mt-2 btn-sm btn btn-primary"
                                    >
                                        Soal
                                    </button>
                                </div>
                                <div class="col-md-6 sm-12">
                                    <button
                                        type="button"
                                        class="w-100 mt-2 btn-sm btn btn-success"
                                    >
                                        {{
                                            exam.question_title
                                                .assessment_type == 4
                                ...
                                >
                                    <button
                                        type="button"
                                        class="w-100 mt-2 btn-sm btn btn-danger"
                                    >
                                        Jawaban Salah
                                    </button>
                                </div>
                                <div class="col-md-6 sm-12">
                                    <button
                                        type="button"
                                        class="w-100 mt-2 btn-sm btn btn-secondary"
                                    >
                                        Tidak Dijawab
                                    </button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0 m-0">
                    <iframe
                        ...
                        id="youtube-video"
                        height="100%"
                        :src="`https://www.youtube.com/embed/${question.discussion_video}?rel=0&modestbranding=1&showinfo=0`"
...
export default {
    ...
    setup(props) {
        ...
        const prevPage = () => {
            ...
            Inertia.get(`/user/grades/${props.grade.id}/questions`, {
