    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            >
                ...
                <div class="ms-auto">
                    <Link
                        :href="`/user/categories/${exam.category_id}/lesson-categories/${exam.lesson_category_id}/lessons/${exam.lesson_id}/exams`"
                    ...
                    <div class="card">
                        <div class="card-header bg-primary">
                            <h5
                                ...
                                href="#collapseDetailTryOutExam"
                                aria-expanded="false"
                                @click="toggleCollapseDetailTryOutExam"
                            >
                                Detail Try Out
                                <a
                                    class="float-end"
                        ...
                        <div
                            class="collapse"
                            :class="{
                                show: collapseDetailTryOutExam,
                                'fade in': true,
                            }"
                            id="collapseDetailTryOutExam"
                        >
                            <div class="card-body">
                                        ...
                                        <tr>
                                            <td colspan="9">
                                                ...
                                                >
                                                    ...
                                                    &nbsp;
                                                    <Link
                                                        :href="`/user/grades/${grade.id}/questions`"
                                                        v-if="
...
export default {
    ...
    setup(props) {
        const collapseDetailTryOutInformation = ref(
            localStorage.getItem("collapseDetailTryOutInformation") !== null
                ? JSON.parse(
                      localStorage.getItem("collapseDetailTryOutInformation")
                  )
                : true
        );
        const collapseDetailTryOutExam = ref(
            localStorage.getItem("collapseDetailTryOutExam") !== null
                ? JSON.parse(localStorage.getItem("collapseDetailTryOutExam"))
                : true
        );

        const toggleCollapseDetailTryOutInformation = () => {
            collapseDetailTryOutInformation.value =
                !collapseDetailTryOutInformation.value;
            localStorage.setItem(
                "collapseDetailTryOutInformation",
                JSON.stringify(collapseDetailTryOutInformation.value)
            );
        };
        ...
        const toggleCollapseDetailTryOutExam = () => {
            ...
            localStorage.setItem(
                "collapseDetailTryOutExam",
                JSON.stringify(collapseDetailTryOutExam.value)
            );
        };
        ...
        const repeatExam = () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.get(
                        `/user/exams/${props.exam.id}/exam-start?repeat=1`
                    );
