                    ...
                    <div class="card-body">
                        <div v-if="questionLists[indexPage]">
                            <div>
                                <div
                                    v-html="
                                        questionLists[indexPage]['question']
                                    "
    ...
    setup(props) {
            ...
            if (props.grade.is_blocked != 1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Inertia.post(
                            `/user/exams/${props.exam.id}/decrement-tolerance`,
                            {
        ...
        const endExam = (block = "") => {
            ...
            if (props.section == props.lastSection || block == "block") {
                Inertia.post(
                    `/user/exams/${props.exam.id}/exam-end`,
                    {
        ...
        if (props.grade.is_blocked == 1) {
            Swal.fire({
                ...
                preConfirm: (token) => {
                    axios
                        .get(
                            `/user/exams/${props.exam.id}/grades/${props.grade.id}/unblocked`,
                            {
                                params: {
                                    token: token,
                                },
