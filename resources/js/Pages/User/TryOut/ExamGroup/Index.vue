                    ...
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        Try Out {{ category.name }}
                                    </h5>
                                    <p class="card-text">
                                        Try Out dari beberapa tes untuk
                                        mengetahui nilai akhir dari tes
                                        {{ category.name }}.
                                    </p>
                                    <Link
