                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-primary">{{
                                            history.exam_group.category.name
                                        }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        {{
                                            history.exam_group.lesson_category
                                                .name
                                        }}
                                    </td>
                                </tr>
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div
                            class="ms-auto"
                            v-if="
                                history.exam_group.certificate_print_user == 1
                            "
                        >
                            <a
                                target="_blank"
                                :href="`/user/exam-groups/${history.id}/export-pdf`"
                                class="btn btn-danger btn-sm m-1"
                                >Cetak Hasil Try Out</a
                            >
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table mb-0">
                            ...
                            <template
                                v-for="(grade, index) in history.exam_group
                                    .grade"
                                :key="index"
                            >
                                <tbody>
                            ...
                            <tfoot v-if="history.is_finished == 1">
                                ...
                                <tr
                                    v-if="
                                        history.exam_group.minimal_grade_type !=
                                        0
                                    "
                                >
