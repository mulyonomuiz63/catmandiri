    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            >
                ...
                <div class="ms-auto">
                    <Link
                        :href="`/user/exam-groups/${lessonCategory.category_id}/lesson-categories`"
            ...
            <div v-if="!examGroups.data.length">
                <div
                    class="row row-cols-12 row-cols-md-12 row-cols-lg-12 row-cols-xl-12"
                >
                    <div class="col">
                ...
                >
                    <div class="card border-bottom border-3 border-0">
                        ...
                        <div class="p-2">
                            <img
                                v-bind:src="
                                    '/storage/upload_files/lesson_categories/' +
                                    exam.lesson_category.thumbnail
                                "
                                class="card-img"
                            />
                        </div>
                        ...
                        <div
                            class="card-body"
                            v-if="$page.props.auth.user.member_type == 2"
                        >
                            <div
                                v-if="
                                    $page.props.setting.purchase_type == 1 ||
                                    $page.props.setting.purchase_type == 3
                                "
                                style="min-height: 50px"
                            >
                                <div
                                    v-if="
                                        exam.price_before_discount ==
                                        exam.price_after_discount
                                    "
                                >
                            ...
                            >
                                <div v-if="exam.member_categories">
                                    <span
                                        v-for="memberCategories in exam.member_categories"
                                        class="badge bg-success mb-0 ms-1"
                                    >
                                        {{ memberCategories }}
                                    </span>
                                </div>
                                <div v-else>
                                    <span class="badge bg-success mb-0"
                                        >Seluruh Member & Non Member</span
                                    >
                                </div>
                            </div>
                        ...
                        <div class="card-footer">
                            <div v-if="exam.exam_status == 'active'">
                                ...
                                >
                                    <div
                                        v-if="
                                            $page.props.setting.purchase_type ==
                                            1
                                        "
                                    >
                                        <div v-if="exam.transaction.length > 0">
                                            <Link
                                                ...
                                                >Kerjakan Try Out</Link
                                            >
                                        </div>
                                        <div v-else>
                                            <button
                                                class="btn btn-outline-primary btn-sm w-100"
                                                @click="buyExam(exam.id)"
                                            >
                                                Beli Try Out
                                            </button>
                                        </div>
                                    ...
                                    >
                                        ...
                                        <div
                                            v-if="exam.transaction.length == 0"
                                        >
                                            <button
        ...
        const buyExam = (examId) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.get(
                        `/user/account-balances/buy-exam/${examId}?type=examGroup`
                    );
                }
            });
        };
        ...
        const checkMemberCategories = (categories) => {
            if (categories) {
                for (const entry of props.userMemberCategories) {
                    if (
                        entry.member_categories.some((category) =>
