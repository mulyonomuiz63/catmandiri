<template>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <h4 class="mb-0 text-uppercase text-center">
                Pilih Voucher Sesuai Targetmu....
            </h4>
            <br />
            <h6 class="text-center">
                Scroll kebawah untuk melihat lebih banyak voucher
            </h6>
            <hr />
                ...
                <div class="row row-cols-1 row-cols-lg-3">
                    ...
                    >
                        <div class="card mb-5 mb-lg-0">
                            <div
                                class="card-header bg-secondary py-3"
                                v-if="voucher.category.name == 'POLRI'"
                            >
                                <h5 class="text-white text-center">
                                    <s
                                        >Rp.{{
                                            formatPrice(
                                                voucher.price_before_discount
                                            )
                                        }}</s
                                    >
                                ...
                                <h6 class="card-price text-white text-center">
                                    Rp.{{
                                        ...
                                        >/{{ voucher.active_period }}
                                        {{
                                            voucher.period_type == "day"
                                                ? "Hari"
                                                : "Bulan"
                                        }}</span
                                    >
                            ...
                            <div
                                class="card-header bg-success py-3"
                                v-else-if="voucher.category.name == 'TNI'"
                            >
                                <h5 class="text-white text-center">
                                    <s
                                        >Rp.{{
                            ...
                            <div
                                class="card-header bg-primary py-3"
                                v-else-if="voucher.category.name == 'Kedinasan'"
                            >
                                <h5 class="text-white text-center">
                                    <s
                                        >Rp.{{
                            ...
                            <div
                                class="card-header bg-danger py-3"
                                v-else-if="voucher.category.name == 'CPNS'"
                            >
                                <h5 class="text-white text-center">
                                    <s
                                        >Rp.{{
                            ...
                            <div class="card-body">
                                ...
                                <div
                                    v-if="
                                        voucher.user_limit &&
                                        voucher.user_limit >
                                            voucher.voucher_selected_transacation_count
                                    "
                                >
                                    <h6 class="text-center">
                                        Tersisa
                                        ...
                                        kuota dari {{ voucher.user_limit }}
                                    </h6>
                                    <hr />
                                </div>
                                <div class="d-grid">
                                    <Link
                                        :href="`/user/vouchers/${voucher.id}/buy`"
        ...
        const buyVoucher = (id, category_id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.get(
                        `/user/vouchers/${id}/buy?category_id=${category_id}`
                    );
                    // Swal.fire({
                    //     title: 'Success!',
