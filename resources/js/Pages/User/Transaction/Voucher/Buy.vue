                        ...
                        >
                            <div class="card-header">
                                <div class="d-lg-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <Link
                                            :href="`/user/vouchers?category_id=${voucher.category_id}`"
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div
                                            v-if="voucher.sub_categories.length"
                                        >
                                            <div
                                                v-for="(
                                                    sub_category, index
                                                ) in voucher.sub_categories"
                                                :key="index"
