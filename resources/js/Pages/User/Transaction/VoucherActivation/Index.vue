<template>
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <h6 class="card-title">Riwayat Aktivasi Voucher</h6>
                    <br />
                            ...
                            <tbody>
                                <tr v-if="!voucherActivations.data.length">
                                    <td colspan="7" align="center">
                                        Belum ada data riwayat aktivasi
                                    </td>
                                </tr>
                                <tr
                                    v-for="(
                                        voucherActivation, index
                                    ) in voucherActivations.data"
                                    :key="index"
                                >
                                    <td>
                                        {{
                                            ++index +
                                            (voucherActivations.current_page -
                                                1) *
                                                voucherActivations.per_page
                                        }}
                                    </td>
                                    <td>
                                        {{ voucherActivation.voucher_code }}
                                    </td>
                                    <td>
                                        {{ voucherActivation.voucher_name }}
                                    </td>
                                    <td>
                                        {{
                                            voucherActivation.voucher_active_period
                                        }}
                                        {{ voucherActivation.voucher_type }}
                                    </td>
                                    <td>
                                        <span
                                            class="badge bg-danger"
                                            v-if="
                                                voucherActivation.voucher_access_type ==
                                                'basic_member'
                                            "
                                            >Basic Member</span
                                        >
                                    ...
                                    <td>
                                        {{
                                            voucherActivation.voucher_expired_date
                                                ? voucherActivation.voucher_expired_date
                                                : "-"
                                        }}
                                    </td>
