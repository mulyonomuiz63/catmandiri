                        ...
                        <div class="card border-bottom border-3 border-0">
                            <div class="card-body">
                                <h5 class="card-title text-center">
                                    Data Materi / Modul Belum Tersedia
                                </h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text" style="min-height: 50px">
                                    {{ materialModule.description }}
                                </p>
                                <div class="text-center">
                                    <!-- <p>Kategori Member</p> -->
                                    <span
                                        v-if="materialModule.member_categories"
                                        v-for="member_categories in materialModule.member_categories"
                                    ...
                                    <div
                                        v-if="
                                            checkMemberCategories(
                                                materialModule.category_id,
                                                materialModule.member_categories
                                            ) == true
                                        "
                                    >
                                        <a
                                            :href="materialModule.link"
                                    ...
                                    <div v-else>
                                        ...
                                        >
                                            ...
                                            >
                                                Upgrade Ke
                                                <span
                                                    v-for="memberCategories in materialModule.member_categories"
                                                >
                                                    {{ memberCategories }}
                                                </span>
                                            </div>
