                        ...
                        <div class="card border-bottom border-3 border-0">
                            <div class="card-body">
                                <h5 class="card-title text-center">
                                    Data Video Pembelajaran Belum Tersedia.
                                </h5>
                            </div>
                        </div>
                    </div>
            ...
            <div v-for="category in categoryVideoModules">
                ...
                <div class="row">
                    <div
                        ...
                        v-for="videoModule in category.video_module"
                    >
                        <div class="card">
                            <span
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <!-- <p>Kategori Member</p> -->
                                    <span
                                        v-if="videoModule.member_categories"
                                        v-for="member_categories in videoModule.member_categories"
                                        class="badge bg-success m-1"
                                    >
                                        {{ member_categories }}
                                    </span>
                                    <span v-else class="badge bg-success mb-0"
                                ...
                                >
                                    <div
                                        v-if="
                                            checkMemberCategories(
                                                videoModule.category_id,
                                                videoModule.member_categories
                                            ) == true
                                        "
                                    >
                                        <a
                                            :href="videoModule.link"
                                    ...
                                    <div v-else>
                                        <Link
                                            :href="`/user/vouchers?category_id=${videoModule.category_id}`"
                                        ...
                                        >
                                            ...
                                            >
                                                Upgrade Ke
                                                <span
                                                    v-for="memberCategories in videoModule.member_categories"
                                                >
                                                    {{ memberCategories }}
                                                </span>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        checkMemberCategories(category_id, categories) {
            var userMemberCategories = this.userMemberCategories.filter(
                function (userMemberCategory) {
