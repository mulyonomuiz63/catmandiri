    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        <div class="sidebar-header">
            <div
                ...
                v-if="$page.props.setting && $page.props.setting.logo"
            >
                <img
                    v-bind:src="
            ...
            <div v-else>
                <h4 class="logo-text" style="font-size: 18px">
                    {{
                        $page.props.setting?.app_name ||
                        "Please set app name in settings"
                    }}
                </h4>
            </div>
                ...
                <ul>
                    ...
                    <li>
                        <Link
                            ...
                            class="menu-clicked"
                        >
                            <i class="bx bx-right-arrow-alt"></i>Kategori Member
                        </Link>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <Link
                            ...
                            class="menu-clicked"
                        >
                            <i class="bx bx-right-arrow-alt"></i>Kategori Mata
                            Pelajaran
                        </Link>
                    </li>
                    <li>
        ...
        <ul class="metismenu" id="menu" v-if="$page.props.auth.user.level == 2">
            ...
            <li>
                ...
                <ul>
                    ...
                    >
                        <Link
                            :href="`/user/categories/${category.id}/lesson-categories`"
                            class="menu-clicked"
                        >
                            <i class="bx bx-right-arrow-alt"></i>Latihan Soal
                        </Link>
            ...
            <li>
                ...
                <ul>
                    ...
                    >
                        <Link
                            :href="`/user/exam-groups/${category.id}/lesson-categories`"
                            class="menu-clicked"
                        >
                            <i class="bx bx-right-arrow-alt"></i>Try Out
                        </Link>
            ...
            <div v-if="$page.props.auth.user.member_type == 2">
                ...
                >
                    ...
                    <ul>
                        ...
                        >
                            <Link
                                :href="`/user/vouchers?category_id=${category.id}`"
                                class="menu-clicked"
                            >
